				...
				<div className="container h-100 pt-3 d-flex flex-column align-items-center">
					<div className="Footer-links d-flex justify-content-center">
						<div className="Footer-link-container d-flex justify-content-center align-items-center">
							<a href="https://github.com/adpalas"><i className="fab fa-github"></i></a>
						</div>
						<div className="Footer-link-container d-flex justify-content-center align-items-center">
							<a href="https://www.linkedin.com/in/aaron-palas-646511126/"><i className="fab fa-linkedin"></i></a>
						</div>
						<div className="Footer-link-container d-flex justify-content-center align-items-center">
							<a href="/my-portfolio/My Resume.docx.pdf"><i className="far fa-file"></i></a>
						</div>
					</div>
